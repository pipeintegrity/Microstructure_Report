...
Final station reports should be in Word so they can facilitate feedback and integrate easily into a package.

Add the uncertainty to the data table for grain size and dark phase, and draw the band in the correlation plots.
...
DT::datatable(station_feature_wt_ndt)
...
![](RabbitSprings/_JT127_Field.jpg){height=350px} ![](RabbitSprings/_JT127_Replica.jpg){height=350px}
<br />
Feature JT-127 micrographs: in-situ (left) and replica (right). 
<br />
<br />
![](RabbitSprings/_JT138.5_Field.jpg){height=350px} ![](RabbitSprings/_JT138.5_Replica.jpg){height=350px}<br />
Feature JT-138.5 micrographs: in-situ (left) and replica (right).
<br />
<br />
![](RabbitSprings/_JT51_Field.jpg){height=350px} ![](RabbitSprings/_JT51_Replica.jpg){height=350px}
<br />
Feature JT-51 micrographs: in-situ (left) and replica (right).
<br />
<br />
![](RabbitSprings/_JT62.5_Field.jpg){height=350px} ![](RabbitSprings/_JT62.5_Replica.jpg){height=350px}
<br />
Feature JT-62.5 micrographs: in-situ (left) and replica (right).
<br />
<br />
![](RabbitSprings/_JT74.5_Field.jpg){height=350px} ![](RabbitSprings/_JT74.5_Replica.jpg){height=350px}
<br />
Feature JT-74.5 micrographs: in-situ (left) and replica (right).
<br />
<br />
![](RabbitSprings/_JT77.4_Field.jpg){height=350px} ![](RabbitSprings/_JT77.4_Replica.jpg){height=350px}
<br />
...
plot1 <- ndt_ten_comp_micro %>% 
  ggplot(aes(astm_grain_size, year)) +
  geom_point(color="steelblue")+
  geom_vline(data = station_micro , aes(xintercept = astm_grain_size, col = feature), lty = 2, show.legend = FALSE)

plot2 <- ndt_ten_comp_micro %>% 
  ggplot(aes(pct_dark_phase, year)) +
  geom_point(color="steelblue")+
...
```{r GS, DP, and Charpy V Notch Upper Shelf Energy, fig.height = 4, fig.width = 10}
