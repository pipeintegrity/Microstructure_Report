...
## MLI GS for cross-sections and replicas
...
```{r GS9, fig.height=12, fig.width=10, fig.align='center', fig.cap = "ASTM GS evaluated for destructive cross-sections and replicas by counting and comparison methods."}
...
## MLI GS for destructive cross-sections and replicas (ascending order)
...
```{r GS11, fig.height=12, fig.width=10, fig.align='center', fig.cap= "ASTM GS evaluated for destructive cross-sections and replicas by the counting and comparison methods (ascending sort)."}
...
## DP for cross-sections and replicas by counting and comparison methods
...
full_join(MICRO_MLI_Avg_Count,MICRO_MLI_Indiv_Count) %>% 
...
```{r individuals vs average dp by counting method, fig.cap= "Individual performance for DP (\u03BCm) by counting method (skips included)"}
...
full_join(MICRO_DP_Avg_Count,MICRO_DP_Indiv_Count) %>% 
...
```{r individuals vs average dp by comparison method, fig.cap= "Individual performance for DP (\u03BCm) by comparison method (skips included)"}
...
full_join(MICRO_DP_Avg_Comp,MICRO_DP_Indiv_Comp) %>% 
...
## GS, DP, and Vintage  
```{r GS, DP, and Vintage, fig.height = 3, fig.width = 10}
...
plot3 <- ndt_ten_comp_GS %>% 
 ...
 grid.arrange(          
  # Apply grid.arrange function
  plot1,plot2,plot3,ncol = 3)

```

## GS, DP, and Grade
```{r GS, DP, and Grade, fig.height = 3, fig.width = 10}
...
```{r GS, DP, and dt, fig.height = 3, fig.width = 10}
...
```{r GS, DP, and Carbon Content, fig.height = 3, fig.width = 10}
...
```{r GS, DP, and Manganese Content, fig.height = 3, fig.width = 10}
...
```{r GS, DP, and Silicon Content, fig.height = 3, fig.width = 10}
...
```{r GS, DP, and Yield Strength, fig.height = 3, fig.width = 10}
...
```{r GS, DP, and Ultimate Tensile Strength, fig.height = 3, fig.width = 10}
...
```{r GS, DP, and Strain Hardening Exponent, fig.height = 3, fig.width = 10}
...
```{r GS, DP, and IIT Predicted Yield Strength, fig.height = 3, fig.width = 10}
...
```{r GS, DP, and IIT Predicted Ultimate Tensile Strength, fig.height = 3, fig.width = 10}
...
```{r GS, DP, and Charpy V Notch Upper Shelf Energy, fig.height = 3, fig.width = 10}
...
```{r GS, DP, and Charpy V Notch Transition Temperature, fig.height = 3, fig.width = 10}
