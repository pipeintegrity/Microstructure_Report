...
```{r histo year, fig.width=7.5}
library(ggplot2)
ggplot(ndt_ten_comp_GS, aes(x=year)) +
  geom_histogram(color="black", binwidth = 5 , fill="steelblue")

```

```{r histo c, fig.width=7.5}
library(ggplot2)
ggplot(ndt_ten_comp_GS, aes(x=c)) +
  geom_histogram(color="black", binwidth = .01 , fill="steelblue")

```

```{r histo mn, fig.width=7.5}
library(ggplot2)
ggplot(ndt_ten_comp_GS, aes(x=mn)) +
  geom_histogram(color="black", binwidth = .1 , fill="steelblue")

```

```{r histo si, fig.width=7.5}
library(ggplot2)
ggplot(ndt_ten_comp_GS, aes(x=si)) +
  geom_histogram(color="black", binwidth = .02 , fill="steelblue")
...
## GS, DP, and IIT Predicted Strain Hardening Exponent
