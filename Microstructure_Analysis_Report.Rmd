...
# data import ----------------------------------------
MICRO <- read_excel("Microstructure_Data_Collection_Online_08.12.2021_S5CJ.xlsx",
                    sheet = "Collection2") %>% 
...
MICRO %>%
  ...
  labs(
    title = paste("Cumulative Evaluations by ID for", year(Sys.Date()) - 1),
    x = "Month",
    y = "Cumulative Count",
    color="Evaluator"
  )
...
MICRO %>%
  ...
  scale_color_viridis_d(option = "C") +
  labs(
    title = paste("Cumulative Evaluations by ID for", year(Sys.Date())),
    x = "Month",
    y = "Cumulative Count",
    color="Evaluator"
  )
...
The plots below indicate how the evaluations by each individual evaluator differ from the average of all evaluations.

Mean Linear Intercept Grain Size (MLI-GS) by the Counting Method:
...
Mean Linear Intercept Grain Size (MLI-GS) by the Comparison Method:
...
Dark Phase (DP) by the Counting Method:
...
Dark Phase (DP) by the Comparison Method:
